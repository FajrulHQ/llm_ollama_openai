...
def load_and_split_pdf(pdf_path, chunk_size=1000):
    ...
    try:
        ...
        # Split text using advanced separators with no chunk overlap
        text_splitter = RecursiveCharacterTextSplitter(
            chunk_size=chunk_size,
            chunk_overlap=0,  # Ensure no overlap between chunks
            length_function=len,
            separators=["."]  # More robust separators
        )
...
def main():
    # Configurations
    pdf_path = "C:/Users/User/pdf_chunking_project/Kesehatan.pdf"
    output_folder = "output_chunks_pdf_kesehatan"
    chunk_size = 1000
